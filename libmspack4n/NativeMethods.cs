...
namespace LibMSPackN
{
	internal static class NativeMethods
	{
		...
		internal struct mscabd_file
		{
		   ...
		   */
			[FieldOffset(0)]
			public IntPtr /*mscabd_file*/ next;
		   ...
		   */
			 ...
			 */
			[FieldOffset(12)]
			public mscabd_file_attribs attribs;
			...
			[FieldOffset(28)]
			public IntPtr /*mscabd_folder*/ folder;
		...
		internal class mscabd_cabinet
		{
			 ...
			 */
			[FieldOffset(0)]
			public IntPtr /*mscabd_cabinet*/ next;
			...
			[FieldOffset(16)]
			public IntPtr /*mscabd_cabinet*/ prevcab;

			/** The next cabinet in a cabinet set, or NULL. */
			[FieldOffset(20)]
			public IntPtr /*mscabd_cabinet*/ nextcab;
			...
			[FieldOffset(40)]
			public IntPtr /*mscabd_file*/ files;

			/** A list of all folders in the cabinet or cabinet set. */
			[FieldOffset(44)]
			public IntPtr /*mscabd_folder*/ folders;
